...
export async function generateMetadata({
  ...
  const dataHome = await fetchWithToken(
    `${ENDPOINT.GET_CHI_TIET_DANH_MUC_SLUG_UNISEX}?slug=${slug}`
  );
  ...
  return {
    ...
    openGraph: {
      ...
      description:
        ...
        seo.description ||
        "Công ty TNHH Kỹ thuật NTS cung cấp các giải pháp kỹ thuật công trình hàng đầu.",
      url: `https://corrjewelry.vn/unisex/${category}/${slug}`,
      images: [
        {
  ...
  return (
    <div className="flex flex-col gap-[70px] pb-[50px] ">
      ...
      <Products
        title={title}
        isFilter={false}
        endpoint={ENDPOINT.GET_PRODUCT_BY_DETAIL_CATEGORY_UNISEX}
        endpointFilter={ENDPOINT.GET_PRODUCT_BY_UNISEX}
        slug={slug}
